...
| carpeta | qué es |
|---|---|
| `cargos/` | Los titulares de los cargos del departamento, 1908–1936, transcriptos del Boletín Oficial acto por acto. `titulares.csv`, `comision.csv` y `tutela.csv`. Cada fila lleva el acto y la edición de donde sale, y dos columnas —`exacta_desde` y `exacta_hasta`— que dicen si la fecha del borde está documentada o no. |
