...
fig.text(0.05, 0.935,
         ...
         f'1323 y 1327 están pero en blanco. De las 2028 a 2032, que el índice no tiene y el apéndice no enumeraba, la 2028 y la 2032 se leyeron\n'
         f'de la copia del autor; faltan las {no_enumeradas[0]} a {no_enumeradas[-1]}, del 19 de noviembre al 3 de diciembre de 1943.',
...
fig.text(0.05, 0.055,
         ...
         'de fuentes del libro; ediciones 2028 y 2032, copia del autor. Una edición presente puede estar en blanco: el índice no lo distingue. Elaboración propia con\nscripts/grafico_boletin.py y datos/boletin/.',
